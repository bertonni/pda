      ...
      <div className="flex">
        ...
        <div className="flex flex-col relative pl-3">
          <section className="border-b border-gray-400 w-44 sm:w-60 md:w-64 lg:w-80">
            ...
            <span className="my-0 text-sm">{currPlayer.position}</span>
          </section>
          <section className="flex flex-col py-2 border-b border-gray-400">
            <div className="flex justify-start">
              <span className="text-xs xs:text-sm w-4/6">Idade:</span>
              <span className="text-xs xs:text-sm font-light text-right">
                {currPlayer.age}
              </span>
            </div>
            <div className="flex justify-start">
              <span className="text-xs xs:text-sm w-4/6">Altura:</span>
              <span className="text-xs xs:text-sm font-light text-right">
                {currPlayer.height}
              </span>
            </div>
            <div className="flex justify-start">
              <span className="text-xs xs:text-sm w-4/6">Pé dominante:</span>
              <span className="text-xs xs:text-sm font-light text-right">
                {currPlayer.foot}
              </span>
            </div>
          ...
          <section className="flex flex-col py-2 border-b border-gray-400">
            <div className="flex justify-start">
              <span className="text-xs xs:text-sm w-4/6">Gols:</span>
              <span className="text-xs xs:text-sm font-light text-right">
                {currPlayer.goals}
              </span>
            </div>
            <div className="flex justify-start">
              <span className="text-xs xs:text-sm w-4/6">Assistências:</span>
              <span className="text-xs xs:text-sm font-light text-right">
                {currPlayer.assists}
              </span>
            </div>
            <div className="flex justify-start">
              <span className="text-xs xs:text-sm w-4/6">Cartões Acum.:</span>
              <span className="text-xs xs:text-sm font-light text-right">
